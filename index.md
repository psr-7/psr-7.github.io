...
#### What is Middleware?
Buzzword for "passing messages around" layers in contrast to "calling specific methods".
There are at least two more types of middlewares (application, communication) which are not related to PSR7.
